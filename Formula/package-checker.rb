class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.10.58.tar.gz"
  version "v1.10.58"
  sha256 "9d217a48f4f64496af00aaa2b1f066076f5d2766c5965184d956554fd1add1f0"
  license "MIT"
