class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.11.40.tar.gz"
  version "v1.11.40"
  sha256 "a2f94bc732efea8ecd84d9ecbd5ce2ed44e08767271cbb1784fb35755aab4f8e"
  license "MIT"
