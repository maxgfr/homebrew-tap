class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.9.50.tar.gz"
  version "v1.9.50"
  sha256 "5843ea086fac6b4c176595af8572f79777eae9d9c55389f61352221c674571e7"
  license "MIT"
