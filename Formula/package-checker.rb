class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.10.190.tar.gz"
  version "v1.10.190"
  sha256 "c7ea7d1458e314804f7c97b6fdfb797c4ef9b15352553175b5ea7ef0db0f71ae"
  license "MIT"
