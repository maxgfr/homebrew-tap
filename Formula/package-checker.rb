class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.10.6.tar.gz"
  version "v1.10.6"
  sha256 "38e923a3b9d03bbc691c565d3641a2b6feeed2ef87de56d0a5a8bc57dc1822f5"
  license "MIT"
