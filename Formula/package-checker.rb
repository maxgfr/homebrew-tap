class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.10.158.tar.gz"
  version "v1.10.158"
  sha256 "ddb9e31a664c9b74edd7e4b8376564c7d093cf6a0d3c67dcbe1323d94ec6a66a"
  license "MIT"
