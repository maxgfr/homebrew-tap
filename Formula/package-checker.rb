class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.10.156.tar.gz"
  version "v1.10.156"
  sha256 "da80bf58d338a714e5a61924a179113816bd55495a650e3c5b55be1569d7a8d9"
  license "MIT"
