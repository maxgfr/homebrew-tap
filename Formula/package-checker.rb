class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.10.110.tar.gz"
  version "v1.10.110"
  sha256 "b62bf907208ee43ede7ae37eb8a9d6188d735bd936e4b7fb6e98bf27eb443e3b"
  license "MIT"
