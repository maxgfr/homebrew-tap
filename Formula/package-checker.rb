class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.10.28.tar.gz"
  version "v1.10.28"
  sha256 "be85e5ce050a784ffb9e5d1c6607eba6085ad371c78ede57ebc4870dd194748f"
  license "MIT"
