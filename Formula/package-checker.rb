class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.10.168.tar.gz"
  version "v1.10.168"
  sha256 "6c6ebcc778434076dfbc6af76145df060a035faef360fc16a1f41378fda09f0d"
  license "MIT"
