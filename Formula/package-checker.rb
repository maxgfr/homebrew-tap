class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.9.63.tar.gz"
  version "v1.9.63"
  sha256 "f9cc70f9b38032166672991a7bdc6bb0b2986dcc49d5cd078d29e1f602424a9e"
  license "MIT"
