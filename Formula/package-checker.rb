class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.9.175.tar.gz"
  version "v1.9.175"
  sha256 "60577379530def9fa49753a685bb20857517069fccd7ab1d19bd8548bd5ac2f8"
  license "MIT"
