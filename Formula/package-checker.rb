class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.9.49.tar.gz"
  version "v1.9.49"
  sha256 "8790d8ab5e2dc23e3b0addc5a43139795b6dbd9845e6f5316c8816b23995b17b"
  license "MIT"
