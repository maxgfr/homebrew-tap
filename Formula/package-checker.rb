class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.9.131.tar.gz"
  version "v1.9.131"
  sha256 "ecabe8dd6366a8ea16b8bf08bc22cb5253cb38cbdd21d758f14aceda2a9f521a"
  license "MIT"
