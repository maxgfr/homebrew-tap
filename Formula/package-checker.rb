class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.9.88.tar.gz"
  version "v1.9.88"
  sha256 "4cac83c505ab0682f8a0dba0db151295d41190f2fbd7e36d9304fd92c9bee34c"
  license "MIT"
