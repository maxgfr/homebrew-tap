class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.9.61.tar.gz"
  version "v1.9.61"
  sha256 "b8db6a0b1e7864ef06e0a9dda0672949fb2d870a97620dd21c4946309a77dbf9"
  license "MIT"
