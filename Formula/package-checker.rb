class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.9.138.tar.gz"
  version "v1.9.138"
  sha256 "b5a0eae194794d2cfea29f98f589400b92d53f3c0a58a4a0e590328299f8da70"
  license "MIT"
