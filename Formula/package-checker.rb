class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.10.132.tar.gz"
  version "v1.10.132"
  sha256 "a49a391814a7e8c3a60740881e08806712feaf8e3e4bff84f762f8c65c38fc3a"
  license "MIT"
