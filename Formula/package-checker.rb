class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.11.23.tar.gz"
  version "v1.11.23"
  sha256 "ec420fbdd974c0d3ec0fbf105601e0ab7a24468ce01e2d165820566ea0f2fa59"
  license "MIT"
