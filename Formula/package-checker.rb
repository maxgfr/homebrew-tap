class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.10.170.tar.gz"
  version "v1.10.170"
  sha256 "a920668b00313e4e67e636c2d0e85fb1a69ef502bc7b90eea99a333000a8ce20"
  license "MIT"
