class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.10.18.tar.gz"
  version "v1.10.18"
  sha256 "1cc2c5581fd00fcdf0966a35bdaeebd8acb7316fe47fb9df2b94508882bef11f"
  license "MIT"
