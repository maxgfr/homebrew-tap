class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.10.178.tar.gz"
  version "v1.10.178"
  sha256 "19a768e1ab9561a4d007892e2d05694fae9a966282210938f7736221a733fc15"
  license "MIT"
