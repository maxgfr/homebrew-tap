class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.11.38.tar.gz"
  version "v1.11.38"
  sha256 "23c607ff4901c8b26362be9cffded6d058a3e1d789ddaea4f3270a29a57cefea"
  license "MIT"
