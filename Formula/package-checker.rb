class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.9.33.tar.gz"
  version "v1.9.33"
  sha256 "f1b31c17909765681a4b800debf9ae2f60c1198ae214bb6f6e14681263de93b1"
  license "MIT"
