class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.10.148.tar.gz"
  version "v1.10.148"
  sha256 "67e0cf37adb5a2f14fe9b83977371006692c0f967f8c49e6f14aba89def078fb"
  license "MIT"
