class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.9.84.tar.gz"
  version "v1.9.84"
  sha256 "4117a1d3d2d9be746ef7f0f2b1175720b44fa163b2beb263738e1299211178df"
  license "MIT"
