class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.9.123.tar.gz"
  version "v1.9.123"
  sha256 "ed7e0a021974dca2d32226ed2bc75bb51d817db21d8f081ead2016e713f480b3"
  license "MIT"
