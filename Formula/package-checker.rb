class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.10.32.tar.gz"
  version "v1.10.32"
  sha256 "922b006145c2039d8a1382f465b9cdf10cdda925f29fe3a3f18353513222a6fc"
  license "MIT"
