class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.9.162.tar.gz"
  version "v1.9.162"
  sha256 "4637760f443d8d6f73a5b30994daa93bac9913f22c0092a85bd8b3a5271106a3"
  license "MIT"
