class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.9.158.tar.gz"
  version "v1.9.158"
  sha256 "b69bfcd946dfab1f3d5872282aaabd7ae35615f32beeb446a06d2cac1458552e"
  license "MIT"
