class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.9.106.tar.gz"
  version "v1.9.106"
  sha256 "956b384b851152e60b9531c1a242005212060e195b0b1f05bbaa199854f39ce0"
  license "MIT"
