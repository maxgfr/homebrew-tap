class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.11.51.tar.gz"
  version "v1.11.51"
  sha256 "be9f7203142506d4318cbccf258dcfc27584dd0a0e4f5aa9ff3ea87dafd3a43c"
  license "MIT"
