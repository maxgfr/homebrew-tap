class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.9.114.tar.gz"
  version "v1.9.114"
  sha256 "7aa420d55f7bb2379f4b33a7ab691671792ea0cb5ab8a8a089680d29ffe8225c"
  license "MIT"
