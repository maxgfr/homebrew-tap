class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.10.118.tar.gz"
  version "v1.10.118"
  sha256 "4968bc5928a76feb41a76f2361771828ddecb11c6eb6e771b7814ad9db9514b6"
  license "MIT"
