class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.10.80.tar.gz"
  version "v1.10.80"
  sha256 "cedf338078ef501c329e846659a5789f8efc7506c75a50684d9e8dc67cdc8e6e"
  license "MIT"
