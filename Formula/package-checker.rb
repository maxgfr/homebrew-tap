class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.11.21.tar.gz"
  version "v1.11.21"
  sha256 "1512ced1cae75301f9d8d9812db6fe46df3808c8331ab5f0d8a34beaf833deea"
  license "MIT"
