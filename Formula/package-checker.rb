class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.10.122.tar.gz"
  version "v1.10.122"
  sha256 "03f6c0bd1d30a8ca4938bcf5b87117878a2a1cb0b2cde9263b3d7d5e8ee8335e"
  license "MIT"
