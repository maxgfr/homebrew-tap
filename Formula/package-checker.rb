class PackageChecker < Formula
  ...
  url "https://github.com/maxgfr/package-checker.sh/archive/refs/tags/v1.9.26.tar.gz"
  version "v1.9.26"
  sha256 "2787fcff896ef4c983fbfd951f8b5323f15adc0816e83689728771efe7b6e8e8"
  license "MIT"
